...
const APP_SHELL = [
  ...
  "./atlas-desktop.js?v=138",
  "./atlas-routing.css?v=29",
  "./atlas-routing-assignment.js?v=1",
  "./atlas-driver-workspace.js?v=1",
  "./atlas-routing-core.js?v=15",
  "./atlas-routing-planner.js?v=9",
  "./atlas-routing-catalog.js?v=2",
  "./atlas-routing-intake.js?v=10",
  "./atlas-routing-storage.js?v=7",
  "./atlas-routing-notifications.js?v=2",
  "./atlas-routing-pod-core.js?v=2",
  "./atlas-routing-pod-queue.js?v=2",
  "./atlas-routing-pod.js?v=7",
  "./atlas-routing.js?v=43",
  "./tools/routing-preview/full-site-client.mjs?v=4",
