...
Covered: private bucket declarations; private-table RLS and grants; office/driver separation; other-driver and TX denial; immutable split numbering; stale revision/allocation; disabled membership; expired/revoked sessions; banned/anonymous users; trusted versus user-editable role data; idempotent receipt finalization; changed retry rejection; and authorization revocation during upload.
...
The schema remains a local preparation draft, not a CLI-generated migration. POD and email remain disabled.
