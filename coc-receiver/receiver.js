(function(){
  ...
  function header(){return `<header class="receiver-head"><div class="receiver-brand"><span>ATLAS WAREHOUSE MANAGEMENT</span><h1>COC RECEIVER</h1><p>Office compliance command center</p></div><div class="receiver-status ${connection==="connected"?"":"is-offline"}"><strong>● ${connection==="connected"?"CONNECTED · READY":connection==="reconnecting"?"RECONNECTING…":"OFFLINE"}</strong><small>Office COC Station</small><small>Last synced ${lastSynced?time(lastSynced):"—"}</small></div></header>`}
